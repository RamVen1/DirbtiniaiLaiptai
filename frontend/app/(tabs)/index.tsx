            ...
            <View className="gap-6">
              ...
              {stats && stats.total_completed > 0 && (
                <View className="flex-row gap-4">
                  <View className="flex-1 bg-card border border-border/20 rounded-3xl p-5 items-center justify-center">
                    <Text className="text-foreground/50 text-[10px] font-bold uppercase tracking-widest">Total Tasks</Text>
                    <Text className="text-primary text-3xl font-black mt-1">{stats.total_completed}</Text>
                  </View>
                  
                  {stats.rank && (
                    <View className="flex-1 bg-primary rounded-3xl p-5 items-center justify-center">
                      <Text className="text-white/70 text-[10px] font-bold uppercase tracking-widest">Your Rank</Text>
                      <View className="flex-row items-baseline gap-1 mt-1">
                        <Text className="text-white text-3xl font-black">#{stats.rank}</Text>
                        <Text className="text-white/60 text-xs">/ {stats.total_participants}</Text>
                      </View>
                    </View>
                  )}
                </View>
              ...
              <View className="bg-card rounded-3xl p-6 items-center justify-center border border-border/20">
                <Animated.View
                  className="w-20 h-20 rounded-full bg-primary/20 items-center justify-center mb-4"
                  style={{ transform: [{ scale: heartScale }] }}
                >
                  <Ionicons name="heart" size={36} color={tint} />
                </Animated.View>
              ...
              <View>
                <Text className="text-xs font-bold uppercase tracking-[0.3em] text-foreground/50 mb-4">
